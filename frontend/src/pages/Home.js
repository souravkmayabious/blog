        ...
        <div className="col-md-8">
          ...
          <article className="blog-post">
            ...
            <p className="blog-post-meta">
              January 1, 2021 by <Link href="#">Mark</Link>
            </p>
            ...
            <p>
              ...
              <Link href="https://developer.mozilla.org/en-US/docs/Web/HTML/Element">
          ...
          <article className="blog-post">
            ...
            <p className="blog-post-meta">
              December 23, 2020 by <Link href="#">Jacob</Link>
            </p>
          ...
          <article className="blog-post">
            ...
            <p className="blog-post-meta">
              December 14, 2020 by <Link href="#">Chris</Link>
            </p>
          ...
          <nav className="blog-pagination" aria-label="Pagination">
            <Link className="btn btn-outline-primary rounded-pill" href="#">
              Older
            </Link>
            <Link
          ...
          <div className="position-sticky" style={{ top: "2rem" }}>
            ...
            <div className="p-4">
              ...
              <ol className="list-unstyled mb-0">
                <li>
                  <Link href="#">March 2021</Link>
                </li>
                <li>
                  <Link href="#">February 2021</Link>
                </li>
                <li>
                  <Link href="#">January 2021</Link>
                </li>
                <li>
                  <Link href="#">December 2020</Link>
                </li>
                <li>
